  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card><CardContent className="pt-4"><p className="text-xs text-muted-foreground">Paid this month</p><p className="text-xl font-bold text-green-500">{formatCurrency(totalFullyPaid)}</p></CardContent></Card>
      </div>
